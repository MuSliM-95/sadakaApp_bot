...
export function TicketsList() {
  ...
  if (!data?.length) {
    return (
      <div className="bg-black/90 flex justify-center border min-h-screen text-white border-neutral-800">
        <div className="max-w-md w-full">
          <PlatformBackButton>
            <Button onClick={updateTicketsPage} className="cursor-pointer mr-2">
              <RotateCcw />
            </Button>
          </PlatformBackButton>
  ...
  return (
    <div
      className={cn(
        "min-h-screen flex justify-center gap-3 bg-neutral-950 text-white"
      )}
    >
      <div className="max-w-md w-full">
        {/* MODAL */}
